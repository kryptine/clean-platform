...
intersperseSpace :: ![String] -> String
intersperseSpace []     = ""
intersperseSpace [x:xs] = x +++ " " +++ intersperseSpace xs

writeBrowserFriendlySVGTag :: !String ![HtmlAttr] ![SVGAttr] ![SVGElt] -> String
writeBrowserFriendlySVGTag tag hattrs sattrs elts = "<" +++ tag +++ " " +++ intersperseSpace (map browserFriendlyHTMLAttrToString hattrs)
                                                                        +++ intersperseSpace (map browserFriendlySVGAttrToString sattrs) +++ ">"
                                                        +++ intersperseSpace (map browserFriendlySVGEltToString elts)
                                                +++ "</" +++ tag +++ ">"
...
writeBrowserFriendlyEmptySVGTag tag hattrs sattrs = "<" +++ tag +++ " " +++ intersperseSpace (map browserFriendlyHTMLAttrToString hattrs)
                                                                        +++ intersperseSpace (map browserFriendlySVGAttrToString sattrs) +++ " />"

browserFriendlySVGEltToString :: !SVGElt -> String
browserFriendlySVGEltToString (SVGElt             html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "svg"              html_attrs svg_attrs elts
browserFriendlySVGEltToString (ClipPathElt        html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "clipPath"         html_attrs svg_attrs elts
browserFriendlySVGEltToString (CircleElt          html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "circle"      html_attrs svg_attrs
browserFriendlySVGEltToString (EllipseElt         html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "ellipse"     html_attrs svg_attrs
browserFriendlySVGEltToString (DefsElt            html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "defs"             html_attrs svg_attrs elts
browserFriendlySVGEltToString (GElt               html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "g"                html_attrs svg_attrs elts
browserFriendlySVGEltToString (ImageElt           html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "image"            html_attrs svg_attrs elts
browserFriendlySVGEltToString (LinearGradientElt  html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "linearGradient"   html_attrs svg_attrs elts
browserFriendlySVGEltToString (LineElt            html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "line"        html_attrs svg_attrs
browserFriendlySVGEltToString (MarkerElt          html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "marker"           html_attrs svg_attrs elts
browserFriendlySVGEltToString (MaskElt            html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "mask"             html_attrs svg_attrs elts
browserFriendlySVGEltToString (PathElt            html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "path"        html_attrs svg_attrs
browserFriendlySVGEltToString (PolygonElt         html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "polygon"     html_attrs svg_attrs
browserFriendlySVGEltToString (PolylineElt        html_attrs svg_attrs)      = writeBrowserFriendlyEmptySVGTag "polyline"    html_attrs svg_attrs
browserFriendlySVGEltToString (RadialGradientElt  html_attrs svg_attrs elts) = writeBrowserFriendlySVGTag "radialGradient"   html_attrs svg_attrs elts
...
writeBrowserFriendlyAttr attr val = attr +++ "=\"" +++ val +++ "\""

browserFriendlySVGAttrToString :: !SVGAttr -> String
browserFriendlySVGAttrToString (AlignmentBaselineAttr   bl)        = writeBrowserFriendlyAttr "alignment-baseline"  bl
browserFriendlySVGAttrToString (BaseProfileAttr         profile)   = writeBrowserFriendlyAttr "baseProfile"         profile
browserFriendlySVGAttrToString (ContentScriptTypeAttr   type)      = writeBrowserFriendlyAttr "contentScriptType"   type
browserFriendlySVGAttrToString (ClipPathAttr            cp)        = writeBrowserFriendlyAttr "clip-path"           cp
browserFriendlySVGAttrToString (CxAttr                  cx)        = writeBrowserFriendlyAttr "cx"                  (toString cx)
browserFriendlySVGAttrToString (CyAttr                  cy)        = writeBrowserFriendlyAttr "cy"                  (toString cy)
browserFriendlySVGAttrToString (DominantBaselineAttr    dbl)       = writeBrowserFriendlyAttr "dominant-baseline"   dbl
browserFriendlySVGAttrToString (ExternalResourcesRequiredAttr b)   = writeBrowserFriendlyAttr "externalResourcesRequired" (if b "true" "false")
browserFriendlySVGAttrToString (FillAttr                paint)     = writeBrowserFriendlyAttr "fill"                (toString paint)
browserFriendlySVGAttrToString (FillOpacityAttr         opac)      = writeBrowserFriendlyAttr "fill-opacity"        (toString opac)
browserFriendlySVGAttrToString (FillRuleAttr            rule)      = writeBrowserFriendlyAttr "fill-rule"           (toString rule)
browserFriendlySVGAttrToString (FontFamilyAttr          family)    = writeBrowserFriendlyAttr "font-family"         (toString family)
browserFriendlySVGAttrToString (FontSizeAttr            size)      = writeBrowserFriendlyAttr "font-size"           (toString size)
browserFriendlySVGAttrToString (FontStyleAttr           style)     = writeBrowserFriendlyAttr "font-style"          (toString style)
browserFriendlySVGAttrToString (FontStretchAttr         stretch)   = writeBrowserFriendlyAttr "font-stretch"        (toString stretch)
browserFriendlySVGAttrToString (FontVariantAttr         variant)   = writeBrowserFriendlyAttr "font-variant"        (toString variant)
browserFriendlySVGAttrToString (FontWeightAttr          weight)    = writeBrowserFriendlyAttr "font-weight"         (toString weight)
browserFriendlySVGAttrToString (LengthAdjustAttr        adjust)    = writeBrowserFriendlyAttr "lengthAdjust"        (toString adjust)
browserFriendlySVGAttrToString (MarkerStartAttr         m)         = writeBrowserFriendlyAttr "marker-start"        m
browserFriendlySVGAttrToString (MarkerMidAttr           m)         = writeBrowserFriendlyAttr "marker-mid"          m
browserFriendlySVGAttrToString (MarkerEndAttr           m)         = writeBrowserFriendlyAttr "marker-end"          m
browserFriendlySVGAttrToString (MarkerHeightAttr        m)         = writeBrowserFriendlyAttr "markerHeight"        (toString m)
browserFriendlySVGAttrToString (MarkerWidthAttr         m)         = writeBrowserFriendlyAttr "markerWidth"         (toString m)
browserFriendlySVGAttrToString (MaskAttr                m)         = writeBrowserFriendlyAttr "mask"                m
browserFriendlySVGAttrToString (OffsetAttr              offset)    = writeBrowserFriendlyAttr "offset"              offset
browserFriendlySVGAttrToString (OrientAttr              orient)    = writeBrowserFriendlyAttr "orient"              orient
browserFriendlySVGAttrToString (PointsAttr              points)    = writeBrowserFriendlyAttr "points"              (foldr (+++) "" (intersperse " " (map (\(x, y) -> x +++ "," +++ y) points)))
browserFriendlySVGAttrToString (PreserveAspectRatioAttr md ma mms) = writeBrowserFriendlyAttr "preserveAspectRatio" (   case md of
                                                                                             Nothing = ""
                                                                                             Just d  = "defer"
                                                                                       +++ case ma of
                                                                                             Nothing = " none"
...
browserFriendlySVGAttrToString (RAttr                   length)    = writeBrowserFriendlyAttr "r"                   (toString length)
browserFriendlySVGAttrToString (RefXAttr                length)    = writeBrowserFriendlyAttr "refX"                (toString length)
browserFriendlySVGAttrToString (RefYAttr                length)    = writeBrowserFriendlyAttr "refY"                (toString length)
browserFriendlySVGAttrToString (RxAttr                  length)    = writeBrowserFriendlyAttr "rx"                  (toString length)
browserFriendlySVGAttrToString (RyAttr                  length)    = writeBrowserFriendlyAttr "ry"                  (toString length)
browserFriendlySVGAttrToString (StopColorAttr           color)     = writeBrowserFriendlyAttr "stop-color"          color
browserFriendlySVGAttrToString (StopOpacityAttr         opacity)   = writeBrowserFriendlyAttr "stop-opacity"        opacity
browserFriendlySVGAttrToString (StrokeAttr              paint)     = writeBrowserFriendlyAttr "stroke"              (toString paint)
browserFriendlySVGAttrToString (StrokeDashArrayAttr     da)        = writeBrowserFriendlyAttr "stroke-dasharray"    (toString da)
browserFriendlySVGAttrToString (StrokeDashOffsetAttr    do)        = writeBrowserFriendlyAttr "stroke-dashoffset"   (toString do)
browserFriendlySVGAttrToString (StrokeLineCapAttr       cap)       = writeBrowserFriendlyAttr "stroke-linecap"      (toString cap)
browserFriendlySVGAttrToString (StrokeLineJoinAttr      join)      = writeBrowserFriendlyAttr "stroke-linejoin"     (toString join)
browserFriendlySVGAttrToString (StrokeMiterLimitAttr    limit)     = writeBrowserFriendlyAttr "stroke-miterlimit"   (toString limit)
browserFriendlySVGAttrToString (StrokeOpacityAttr       opac)      = writeBrowserFriendlyAttr "stroke-opacity"      opac
browserFriendlySVGAttrToString (StrokeWidthAttr         width)     = writeBrowserFriendlyAttr "stroke-width"        (toString width)
browserFriendlySVGAttrToString (TextAnchorAttr          anchor)    = writeBrowserFriendlyAttr "text-anchor"         anchor
browserFriendlySVGAttrToString (TextLengthAttr          length)    = writeBrowserFriendlyAttr "textLength"          (toString length)
browserFriendlySVGAttrToString (TextRenderingAttr       rendering) = writeBrowserFriendlyAttr "text-rendering"      rendering
browserFriendlySVGAttrToString (TransformAttr           ts)        = writeBrowserFriendlyAttr "transform"           (glue_list " " (map toString ts))
browserFriendlySVGAttrToString (VersionAttr             v)         = writeBrowserFriendlyAttr "version"             v
browserFriendlySVGAttrToString (ViewBoxAttr             x y w h)   = writeBrowserFriendlyAttr "viewBox"             (glue_list " " [x,y,w,h])
browserFriendlySVGAttrToString (XAttr                   x)         = writeBrowserFriendlyAttr "x"                   (toString x)
browserFriendlySVGAttrToString (X1Attr                  x1)        = writeBrowserFriendlyAttr "x1"                  (toString x1)
browserFriendlySVGAttrToString (X2Attr                  x2)        = writeBrowserFriendlyAttr "x2"                  (toString x2)
browserFriendlySVGAttrToString (XLinkHRefAttr           iri)       = writeBrowserFriendlyAttr "xlink:href"          iri
browserFriendlySVGAttrToString (YAttr                   y)         = writeBrowserFriendlyAttr "y"                   (toString y)
browserFriendlySVGAttrToString (Y1Attr                  y1)        = writeBrowserFriendlyAttr "y1"                  (toString y1)
browserFriendlySVGAttrToString (Y2Attr                  y2)        = writeBrowserFriendlyAttr "y2"                  (toString y2)
browserFriendlySVGAttrToString (ZoomAndPanAttr          zap)       = writeBrowserFriendlyAttr "zoomAndPan"          (toString zap)

browserFriendlyHTMLAttrToString :: !HtmlAttr -> String
browserFriendlyHTMLAttrToString (AbbrAttr a)      = writeBrowserFriendlyAttr "abbr" a
browserFriendlyHTMLAttrToString (AcceptAttr a)    = writeBrowserFriendlyAttr "accept" a
browserFriendlyHTMLAttrToString (AcceptcharsetAttr a)  = writeBrowserFriendlyAttr "accept-charset" a
browserFriendlyHTMLAttrToString (AccesskeyAttr a)    = writeBrowserFriendlyAttr "accesskey" a
browserFriendlyHTMLAttrToString (ActionAttr a)    = writeBrowserFriendlyAttr "action" a
browserFriendlyHTMLAttrToString (AlignAttr a)      = writeBrowserFriendlyAttr "align" a
browserFriendlyHTMLAttrToString (AlinkAttr a)      = writeBrowserFriendlyAttr "alink" a
browserFriendlyHTMLAttrToString (AltAttr a)      = writeBrowserFriendlyAttr "alt" a
browserFriendlyHTMLAttrToString (ArchiveAttr a)    = writeBrowserFriendlyAttr "archive" a
browserFriendlyHTMLAttrToString (AxisAttr a)      = writeBrowserFriendlyAttr "axis" a
browserFriendlyHTMLAttrToString (BackgroundAttr a)  = writeBrowserFriendlyAttr "background" a
browserFriendlyHTMLAttrToString (BgcolorAttr a)    = writeBrowserFriendlyAttr "bgcolor" a
browserFriendlyHTMLAttrToString (BorderAttr a)    = writeBrowserFriendlyAttr "border" a
browserFriendlyHTMLAttrToString (CellspacingAttr a)  = writeBrowserFriendlyAttr "cellspacing" a
browserFriendlyHTMLAttrToString (CellpaddingAttr a)  = writeBrowserFriendlyAttr "cellpadding" a
browserFriendlyHTMLAttrToString (CharAttr a)      = writeBrowserFriendlyAttr "char" a
browserFriendlyHTMLAttrToString (CharoffAttr a)    = writeBrowserFriendlyAttr "charoff" a
browserFriendlyHTMLAttrToString (CharsetAttr a)    = writeBrowserFriendlyAttr "charset" a
browserFriendlyHTMLAttrToString (CheckedAttr)      = writeBrowserFriendlyAttr "checked" "checked"
browserFriendlyHTMLAttrToString (CiteAttr a)      = writeBrowserFriendlyAttr "cite" a
browserFriendlyHTMLAttrToString (ClassAttr a)      = writeBrowserFriendlyAttr "class" a
browserFriendlyHTMLAttrToString (ClassidAttr a)    = writeBrowserFriendlyAttr "classid" a
browserFriendlyHTMLAttrToString (ColorAttr a)      = writeBrowserFriendlyAttr "color" a
browserFriendlyHTMLAttrToString (ColsAttr a)      = writeBrowserFriendlyAttr "cols" a
browserFriendlyHTMLAttrToString (ColspanAttr a)    = writeBrowserFriendlyAttr "colspan" a
browserFriendlyHTMLAttrToString (CodebaseAttr a)    = writeBrowserFriendlyAttr "codebase" a
browserFriendlyHTMLAttrToString (CodetypeAttr a)    = writeBrowserFriendlyAttr "codetype" a
browserFriendlyHTMLAttrToString (ContentAttr a)    = writeBrowserFriendlyAttr "content" a
browserFriendlyHTMLAttrToString (CompactAttr)      = writeBrowserFriendlyAttr "compact" "compact"
browserFriendlyHTMLAttrToString (CoordsAttr a)    = writeBrowserFriendlyAttr "coords" a
browserFriendlyHTMLAttrToString (DataAttr a)      = writeBrowserFriendlyAttr "data" a
browserFriendlyHTMLAttrToString (DatetimeAttr a)    = writeBrowserFriendlyAttr "datetime" a
browserFriendlyHTMLAttrToString (DeclareAttr)      = writeBrowserFriendlyAttr "declare" "declare"
browserFriendlyHTMLAttrToString (DeferAttr a)      = writeBrowserFriendlyAttr "defer" a
browserFriendlyHTMLAttrToString (DirAttr a)      = writeBrowserFriendlyAttr "dir" a
browserFriendlyHTMLAttrToString (DisabledAttr)    = writeBrowserFriendlyAttr "disabled" "disabled"
browserFriendlyHTMLAttrToString (DXAttr a)      = writeBrowserFriendlyAttr "dx" a
browserFriendlyHTMLAttrToString (DYAttr a)      = writeBrowserFriendlyAttr "dy" a
browserFriendlyHTMLAttrToString (EnctypeAttr a)    = writeBrowserFriendlyAttr "enctype" a
browserFriendlyHTMLAttrToString (FaceAttr a)      = writeBrowserFriendlyAttr "face" a
browserFriendlyHTMLAttrToString (ForAttr a)      = writeBrowserFriendlyAttr "for" a
browserFriendlyHTMLAttrToString (FrameAttr a)      = writeBrowserFriendlyAttr "frame" a
browserFriendlyHTMLAttrToString (FrameborderAttr a)  = writeBrowserFriendlyAttr "frameborder" a
browserFriendlyHTMLAttrToString (HeadersAttr a)    = writeBrowserFriendlyAttr "headers" a
browserFriendlyHTMLAttrToString (HeightAttr a)    = writeBrowserFriendlyAttr "height" a
browserFriendlyHTMLAttrToString (HrefAttr a)      = writeBrowserFriendlyAttr "href" a
browserFriendlyHTMLAttrToString (HreflangAttr a)    = writeBrowserFriendlyAttr "hreflang" a
browserFriendlyHTMLAttrToString (HttpequivAttr a)    = writeBrowserFriendlyAttr "http-equiv" a
browserFriendlyHTMLAttrToString (HspaceAttr a)    = writeBrowserFriendlyAttr "hspace" a
browserFriendlyHTMLAttrToString (IdAttr a)      = writeBrowserFriendlyAttr "id" a
browserFriendlyHTMLAttrToString (IsmapAttr)      = writeBrowserFriendlyAttr "ismap" "ismap"
browserFriendlyHTMLAttrToString (LabelAttr a)      = writeBrowserFriendlyAttr "label" a
browserFriendlyHTMLAttrToString (LangAttr a)      = writeBrowserFriendlyAttr "lang" a
browserFriendlyHTMLAttrToString (LanguageAttr a)    = writeBrowserFriendlyAttr "language" a
browserFriendlyHTMLAttrToString (LinkAttr a)      = writeBrowserFriendlyAttr "link" a
browserFriendlyHTMLAttrToString (LongdescAttr a)    = writeBrowserFriendlyAttr "longdesc" a
browserFriendlyHTMLAttrToString (MarginheightAttr a)  = writeBrowserFriendlyAttr "marginheight" a
browserFriendlyHTMLAttrToString (MarginwidthAttr a)  = writeBrowserFriendlyAttr "marginwidth" a
browserFriendlyHTMLAttrToString (MaxlengthAttr a)    = writeBrowserFriendlyAttr "maxlength" a
browserFriendlyHTMLAttrToString (MediaAttr a)      = writeBrowserFriendlyAttr "media" a
browserFriendlyHTMLAttrToString (MethodAttr a)    = writeBrowserFriendlyAttr "method" a
browserFriendlyHTMLAttrToString (MultipleAttr)    = writeBrowserFriendlyAttr "multiple" "multiple"
browserFriendlyHTMLAttrToString (NameAttr a)      = writeBrowserFriendlyAttr "name" a
browserFriendlyHTMLAttrToString (NohrefAttr)      = writeBrowserFriendlyAttr "nohref" "nohref"
browserFriendlyHTMLAttrToString (NoshadeAttr)      = writeBrowserFriendlyAttr "noshade" "noshade"
browserFriendlyHTMLAttrToString (NowrapAttr)      = writeBrowserFriendlyAttr "nowrap" "nowrap"
browserFriendlyHTMLAttrToString (OnblurAttr a)    = writeBrowserFriendlyAttr "onblur" a
browserFriendlyHTMLAttrToString (OnchangeAttr a)    = writeBrowserFriendlyAttr "onchange" a
browserFriendlyHTMLAttrToString (OnclickAttr a)    = writeBrowserFriendlyAttr "onclick" a
browserFriendlyHTMLAttrToString (OndblclickAttr a)  = writeBrowserFriendlyAttr "ondblclick" a
browserFriendlyHTMLAttrToString (OnfocusAttr a)    = writeBrowserFriendlyAttr "onfocus" a
browserFriendlyHTMLAttrToString (OnloadAttr a)    = writeBrowserFriendlyAttr "onload" a
browserFriendlyHTMLAttrToString (OnmousedownAttr a)  = writeBrowserFriendlyAttr "onmousedown" a
browserFriendlyHTMLAttrToString (OnmousemoveAttr a)  = writeBrowserFriendlyAttr "onmousemove" a
browserFriendlyHTMLAttrToString (OnmouseoutAttr a)  = writeBrowserFriendlyAttr "onmouseout" a
browserFriendlyHTMLAttrToString (OnmouseoverAttr a)  = writeBrowserFriendlyAttr "onmouseover" a
browserFriendlyHTMLAttrToString (OnmouseupAttr a)    = writeBrowserFriendlyAttr "onmouseup" a
browserFriendlyHTMLAttrToString (OnkeydownAttr a)    = writeBrowserFriendlyAttr "onkeydown" a
browserFriendlyHTMLAttrToString (OnkeypressAttr a)  = writeBrowserFriendlyAttr "onkeypress" a
browserFriendlyHTMLAttrToString (OnkeyupAttr a)    = writeBrowserFriendlyAttr "onkeyup" a
browserFriendlyHTMLAttrToString (OnresetAttr a)    = writeBrowserFriendlyAttr "onreset" a
...
browserFriendlyHTMLAttrToString (RelAttr a)      = writeBrowserFriendlyAttr "rel" a
browserFriendlyHTMLAttrToString (RevAttr a)      = writeBrowserFriendlyAttr "rev" a
browserFriendlyHTMLAttrToString (RowsAttr a)      = writeBrowserFriendlyAttr "rows" a
browserFriendlyHTMLAttrToString (RowspanAttr a)    = writeBrowserFriendlyAttr "rowspan" a
browserFriendlyHTMLAttrToString (RulesAttr a)      = writeBrowserFriendlyAttr "rules" a
browserFriendlyHTMLAttrToString (RXAttr a)      = writeBrowserFriendlyAttr "rx" a
browserFriendlyHTMLAttrToString (RYAttr a)      = writeBrowserFriendlyAttr "ry" a
browserFriendlyHTMLAttrToString (SchemeAttr a)    = writeBrowserFriendlyAttr "scheme" a
browserFriendlyHTMLAttrToString (ScopeAttr a)      = writeBrowserFriendlyAttr "scope" a
browserFriendlyHTMLAttrToString (ScrollingAttr a)    = writeBrowserFriendlyAttr "scrolling" a
browserFriendlyHTMLAttrToString (SelectedAttr)    = writeBrowserFriendlyAttr "selected" "selected"
browserFriendlyHTMLAttrToString (ShapeAttr a)      = writeBrowserFriendlyAttr "shape" a
browserFriendlyHTMLAttrToString (SizeAttr a)      = writeBrowserFriendlyAttr "size" a
browserFriendlyHTMLAttrToString (SpanAttr a)      = writeBrowserFriendlyAttr "span" a
browserFriendlyHTMLAttrToString (SrcAttr a)      = writeBrowserFriendlyAttr "src" a
browserFriendlyHTMLAttrToString (StandbyAttr a)    = writeBrowserFriendlyAttr "standby" a
browserFriendlyHTMLAttrToString (StartAttr a)      = writeBrowserFriendlyAttr "start" a
browserFriendlyHTMLAttrToString (StyleAttr a)      = writeBrowserFriendlyAttr "style" a
browserFriendlyHTMLAttrToString (SummaryAttr a)    = writeBrowserFriendlyAttr "summary" a
browserFriendlyHTMLAttrToString (TabindexAttr a)    = writeBrowserFriendlyAttr "tabindex" a
browserFriendlyHTMLAttrToString (TargetAttr a)    = writeBrowserFriendlyAttr "target" a
browserFriendlyHTMLAttrToString (TextAttr a)      = writeBrowserFriendlyAttr "text" a
browserFriendlyHTMLAttrToString (TitleAttr a)      = writeBrowserFriendlyAttr "title" a
browserFriendlyHTMLAttrToString (TypeAttr a)      = writeBrowserFriendlyAttr "type" a
browserFriendlyHTMLAttrToString (UsemapAttr a)    = writeBrowserFriendlyAttr "usemap" a
browserFriendlyHTMLAttrToString (ValignAttr a)    = writeBrowserFriendlyAttr "valign" a
browserFriendlyHTMLAttrToString (ValueAttr a)      = writeBrowserFriendlyAttr "value" a
browserFriendlyHTMLAttrToString (ValuetypeAttr a)    = writeBrowserFriendlyAttr "valuetype" a
browserFriendlyHTMLAttrToString (VlinkAttr a)      = writeBrowserFriendlyAttr "vlink" a
browserFriendlyHTMLAttrToString (VspaceAttr a)    = writeBrowserFriendlyAttr "vspace" a
browserFriendlyHTMLAttrToString (WidthAttr a)      = writeBrowserFriendlyAttr "width" a
browserFriendlyHTMLAttrToString (XmllangAttr a)    = writeBrowserFriendlyAttr "xml:lang" a
browserFriendlyHTMLAttrToString (XmlnsAttr a)      = writeBrowserFriendlyAttr "xmlns" a
